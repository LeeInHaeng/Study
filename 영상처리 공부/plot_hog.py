...
backImage = cv2.imread('image/picture_art_d.jpg')
    
fd1, hog_image1 = hog(backImage, orientations=8, pixels_per_cell=(16, 16),
...
#gray1= cv2.cvtColor(hog_image_rescaled2,cv2.COLOR_BGR2GRAY)

hog_image_rescaled1 = img_as_ubyte(hog_image_rescaled1)
kp1, des1 = surf.detectAndCompute(hog_image_rescaled1,None)
hog_image_rescaled1 = cv2.drawKeypoints(hog_image_rescaled1,kp1,None,(255,0,0),2)
fig = plt.figure()
fig.set_size_inches((15,15))
plt.imshow(hog_image_rescaled1, 'gray'),plt.show()